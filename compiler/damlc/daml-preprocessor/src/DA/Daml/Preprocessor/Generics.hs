...
from_RDR  = mkRdrUnqual $ mkOccName varName "from"-- varQual_RDR gHC_GENERICS (fsLit "from")
_from1_RDR = varQual_RDR gHC_GENERICS (fsLit "from1")
to_RDR    = mkRdrUnqual $ mkOccName varName "to" -- varQual_RDR gHC_GENERICS (fsLit "to")
